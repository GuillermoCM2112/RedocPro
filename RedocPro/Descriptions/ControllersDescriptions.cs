namespace RedocPro.Descriptions
{
	public static class ControllersDescriptions
	{
        ...
        public const string HealthController = @"Health controller description goes here.";
        public const string NethoneController = @"Nethone controller description goes here.";
